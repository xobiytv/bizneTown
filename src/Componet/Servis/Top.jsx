...
const PerformanceMetrics = () => {
  return (
    <div className="h-full bg-black text-white py-16 px-4 md:px-8">
      ...
      <div className="bg-gray-900 p-4 sm:p-6 mt-8 rounded-lg text-center flex flex-col items-center">
